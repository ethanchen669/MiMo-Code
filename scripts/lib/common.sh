...
export MIMOCODE_BUILTIN_SKILLS_DIR="${MIMOCODE_BUILTIN_SKILLS_DIR:-$HOME/.local/share/mimocode/builtin_skills}"
export MIMOCODE_COMPOSE_DIR="${MIMOCODE_COMPOSE_DIR:-$HOME/.local/share/mimocode/compose}"
export MIMOCODE_COMPOSE_LATEST="$MIMOCODE_COMPOSE_DIR/latest"
